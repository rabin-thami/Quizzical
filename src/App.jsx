...
const App = () => {
    ...
    return (
        <main>
            <svg className ="top-svg" width="158" height="141" viewBox="0 0 158 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="bottom-svg" width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
